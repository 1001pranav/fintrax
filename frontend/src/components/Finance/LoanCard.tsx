...
export default function LoanCard({ loan, onEdit, onDelete }: LoanCardProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-orange-500/10 to-red-600/5 border border-white/10 rounded-2xl p-5 backdrop-blur-xl hover:bg-white/5 transition-all duration-200 group">
