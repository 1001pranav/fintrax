          ...
          <div className="flex items-center justify-between p-4 sm:p-6 border-b border-white/10">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <button
                ...
                className="px-3 sm:px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg transform transition-all duration-200 hover:scale-105 hover:shadow-xl flex items-center space-x-1 sm:space-x-2"
              >
                <SVGComponent 
                  svgType={"plus"}
                />
              ...
              <div className="relative">
                <button
                  ...
                  className={`p-2 sm:px-4 sm:py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg transform transition-all duration-200 hover:scale-105 hover:shadow-xl flex items-center space-x-2 ${
