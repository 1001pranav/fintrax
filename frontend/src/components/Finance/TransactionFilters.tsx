        ...
        <div className="flex items-center space-x-2">
          {hasActiveFilters && (
            <button
              ...
              className="px-3 py-1 text-sm text-red-400 hover:bg-red-500/10 rounded-lg transition-colors duration-200"
            >
              Clear
            </button>
          )}
        ...
        <div className="p-4 pt-0 space-y-4 border-t border-white/10">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-xl text-white backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-400/50 transition-all duration-200 hover:bg-white/15"
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-xl text-white backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-400/50 transition-all duration-200 hover:bg-white/15 text-sm"
                />
              </div>
              <div className="space-y-1">
